...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/BleEggLight.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=src/ble.c src/comman.c src/eeprom.c src/key.c src/led.c src/main.c src/rtc.c src/eusart.c src/pin.c src/pwm.c src/tmr.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/ble.p1 ${OBJECTDIR}/src/comman.p1 ${OBJECTDIR}/src/eeprom.p1 ${OBJECTDIR}/src/key.p1 ${OBJECTDIR}/src/led.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/rtc.p1 ${OBJECTDIR}/src/eusart.p1 ${OBJECTDIR}/src/pin.p1 ${OBJECTDIR}/src/pwm.p1 ${OBJECTDIR}/src/tmr.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/ble.p1.d ${OBJECTDIR}/src/comman.p1.d ${OBJECTDIR}/src/eeprom.p1.d ${OBJECTDIR}/src/key.p1.d ${OBJECTDIR}/src/led.p1.d ${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/rtc.p1.d ${OBJECTDIR}/src/eusart.p1.d ${OBJECTDIR}/src/pin.p1.d ${OBJECTDIR}/src/pwm.p1.d ${OBJECTDIR}/src/tmr.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/ble.p1 ${OBJECTDIR}/src/comman.p1 ${OBJECTDIR}/src/eeprom.p1 ${OBJECTDIR}/src/key.p1 ${OBJECTDIR}/src/led.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/rtc.p1 ${OBJECTDIR}/src/eusart.p1 ${OBJECTDIR}/src/pin.p1 ${OBJECTDIR}/src/pwm.p1 ${OBJECTDIR}/src/tmr.p1

# Source Files
SOURCEFILES=src/ble.c src/comman.c src/eeprom.c src/key.c src/led.c src/main.c src/rtc.c src/eusart.c src/pin.c src/pwm.c src/tmr.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/BleEggLight.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/BleEggLight.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/BleEggLight.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/BleEggLight.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/BleEggLight.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/BleEggLight.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/BleEggLight.X.${IMAGE_TYPE}.map  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/BleEggLight.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
